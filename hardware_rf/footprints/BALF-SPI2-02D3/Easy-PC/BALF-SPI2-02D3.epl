...
(library Library_1
	...
	(patternDef "BALFSPI202D3" (originalName "BALFSPI202D3")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.05 -0.775) (pt 1.05 -0.775) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.05 -0.775) (pt 1.05 0.775) (width 0.1))
		)
	...
	(compDef "BALF-SPI2-02D3" (originalName "BALF-SPI2-02D3") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "RXP") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "RXN") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "TX") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "GND_1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "ANT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.st.com/resource/en/datasheet/balf-spi2-02d3.pdf")
		(attr "Height" "0.68 mm")
	)
